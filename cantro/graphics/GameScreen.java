...
public class GameScreen extends JPanel {
    ...
    public GameScreen(Cantro c)
    {
		...
		//set this to an empty string on windows + eclipse
		//custom string on other OS.
		
		
    	try
    	{
    		File f = new File("cantro/resources/actualMaps/GrasslandMap.png");
    		viewedImage = ImageIO.read(f);
    		f = new File("cantro/resources/actualMaps/GrasslandSkeleton.png");
    		skeletonImage = ImageIO.read(f);
    		f = new File("cantro/resources/images/bullet.png");
    		bulletImage = ImageIO.read(f);
    		f = new File("cantro/resources/images/menu.png");
    		menuImage = ImageIO.read(f);
    		playerPictures = new Image[2][2];
    			playerPictures[0][0]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/CRLB.gif");
    			playerPictures[0][1]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/CSLB.gif");
    			playerPictures[1][0]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/CRRB.gif");
    			playerPictures[1][1]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/CSRB.gif");
    		zombiePictures = new Image[2][2];
				zombiePictures[0][0]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/ZRunningLeft.gif");
				zombiePictures[0][1]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/MSLB.gif");
				zombiePictures[1][0]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/ZRunningRight.gif");
				zombiePictures[1][1]=Toolkit.getDefaultToolkit().getImage("cantro/resources/images/sprites/MSRB.gif");
    ...
    public void paintComponent(Graphics g)
    {
		...
		{
			bG.drawImage(viewedImage.getSubimage(viewedx, viewedy, 800, 600),0,0,null);//viewedImage,0,0,null);
			//bG.drawImage(skeletonImage.getSubimage(viewedx, viewedy, 800, 600),0,0,null);//viewedImage,0,0,null);
			    			...
			    			else if(mb.text.equals("Select Name"))
			    			{
			    				Thread x = new Thread(){
			    					public void run()
			    					{
			    						...
			    						if(tmp != null && tmp.contains(":")) JOptionPane.showMessageDialog(null, "No colons allowed!");
			    						else if(tmp != null && !tmp.trim().equals("")) selectedName = tmp;
			    					}
			    				};
			    				x.start();
    ...
    {
    	for(int i = 0; i < 100; i++)
    		new Zombie((int)(Math.random()*1100)+100,0,owner);
    ...
    public void paintRedLine(Player p, Graphics2D bG)
    {
		...
		{
			if(y > owner.mouseInput.hovery)
				bG.drawLine(x,y,x,0);
			else
				bG.drawLine(x,y,x,600);
		}
    }
